        ...
        <div id="top_links">
            ...
            <table style="width:897px; background:#FFFFFF; margin:0 auto;">
                <tr>
                    ...
                    <td>
                    <td width="900" valign="top">
                        <div id="welcome" style="border-right:#666666 1px dotted;"><h1></h1>
                            <table  align="center" bgcolor="white">
                                <td>
                                    <h1>Transfer To Beneficiary</h1><br/>
                                    <form action="transfer_friend_servlet" method="post">
                                        <input type="submit" value="Beneficiary Transfer"/><br/><br/>
                                    </form>
                                    <form action="add_friend_page.jsp">
                                        <input type="submit" value="Add Beneficiary"/><br/><br/>
                                    </form>
                                    <form action="remove_friend_servlet" method="post">
                                        <input type="submit" value="Remove Beneficiary"/><br/><br/>
                                    </form>
