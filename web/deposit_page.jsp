            ...
            <table style="width:897px; background:#FFFFFF; margin:0 auto;">
                <tr >
                    ...
                    <td width="900" valign="top">
                        <div id="welcome" style="border-right:#666666 1px dotted;"><h1>Amount Deposit</h1><br>
                                ...
                                <td>
                                    ...
                                    <form action="deposit_servlet" method="post">
                                        <table cellspacing="5" cellpadding="3">
                                            ...
                                            <tr><td>AMOUNT:</td><td>  <input type="text" name="amount" placeholder="Amount" title="Minimum amount 100"required="required" pattern="[0-9]{3,}"/></td></tr>
                                            <tr><td></td><td> <input type="submit" value="Deposit"/></td></tr>
                                        </table>
                                    </form>
                                </td></table>
                        </div>
