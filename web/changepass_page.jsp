                        ...
                        <div id="welcome" style="border-right:#666666 1px dotted;"><h1>Reset Password</h1><br>
                            <table  align="center" bgcolor="white">
                                ...
                                <td>
                                    ...
                                    <form action="changepass_servlet" method="post">
                                        New: <input type="text" name="password" placeholder="Password" required="required"/><br><br>
                                        Re-Type: <input type="text" name="re_password" placeholder="Password" required="required"/><br><br>
